  ...
  Widget _buildFormLogin() {
    return Column(
      ...
      children: [
        ...
        BlocSelector<AuthBloc, BaseState<UserEntity>, String?>(
          selector: (state) {
            if (state.isError) {
        ...
        24.verticalSpace,
        BlocSelector<AuthBloc, BaseState<UserEntity>, bool>(
          selector: (state) {
            if (state.isLoading) {
              return true;
            }
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Padding(
                      ...
                      child: ConstrainedBox(
                        ...
                        child: BlocListener<AuthBloc, BaseState<UserEntity>>(
                          listener: (context, state) {
                            if (state.isLoading) {
                              ...
                              Fluttertoast.showToast(
                                msg: state.errorMessage ?? 'Login Gagal',
