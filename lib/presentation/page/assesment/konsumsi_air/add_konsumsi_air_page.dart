...
class _AddKonsumsiAirPageState extends State<AddKonsumsiAirPage> {
  ...
  final antropometri = sl<AntropometriCubit>().state.data;
  final water = sl<WaterCubit>().state.data;
  ...
  int getRecommend() {
    double weight = antropometri?.weight ?? 0;
  ...
  @override
  void initState() {
    currentTarget = water?.last.target ?? getRecommend();
    super.initState();
  }
