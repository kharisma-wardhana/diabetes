...
mixin _$Article {
 ...
 int get id;@JsonKey(name: 'judul') String get title; String get content; String? get image; String? get audio;@JsonKey(name: 'created_at') String get createdAt;@JsonKey(name: 'updated_at') String get updatedAt;
...
@override
String toString() {
  return 'Article(id: $id, title: $title, content: $content, image: $image, audio: $audio, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'judul') String title, String content, String? image, String? audio,@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'updated_at') String updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'judul')  String title,  String content,  String? image,  String? audio, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Article() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'judul')  String title,  String content,  String? image,  String? audio, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Article():
return $default(_that.id,_that.title,_that.content,_that.image,_that.audio,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'judul')  String title,  String content,  String? image,  String? audio, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Article() when $default != null:
return $default(_that.id,_that.title,_that.content,_that.image,_that.audio,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Article extends Article {
   _Article({required this.id, @JsonKey(name: 'judul') required this.title, required this.content, this.image, this.audio, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt}): super._();
